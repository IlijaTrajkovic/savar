...
modes_weights[1, :comp_size, comp_size:2*comp_size] = create_random_mode((comp_size, comp_size), random=False)
modes_weights[2, :comp_size, 2*comp_size:3*comp_size] = create_random_mode((comp_size, comp_size), random=False)
modes_weights[3, :comp_size, comp_size*3:] = create_random_mode((comp_size, comp_size), random=False)
modes_weights[4, comp_size:2*comp_size, :comp_size] = create_random_mode((comp_size, comp_size), random=False)
modes_weights[5, comp_size:2*comp_size, comp_size:2*comp_size] = create_random_mode((comp_size, comp_size), random=False)
modes_weights[6, comp_size:2*comp_size, 2*comp_size:3*comp_size] = create_random_mode((comp_size, comp_size), random=False)
modes_weights[7, comp_size:2*comp_size, 3*comp_size:] = create_random_mode((comp_size, comp_size), random=False)
modes_weights[8, 2*comp_size:3*comp_size, :comp_size] = create_random_mode((comp_size, comp_size), random=False)
modes_weights[9, 2*comp_size:3*comp_size, comp_size:2*comp_size] = create_random_mode((comp_size, comp_size), random=False)
modes_weights[10, 2*comp_size:3*comp_size, 2*comp_size:3*comp_size] = create_random_mode((comp_size, comp_size), random=False)
modes_weights[11, 2*comp_size:3*comp_size, 3*comp_size:] = create_random_mode((comp_size, comp_size), random=False)
modes_weights[12, 3*comp_size:, :comp_size] = create_random_mode((comp_size, comp_size), random=False)
modes_weights[13, 3*comp_size:, comp_size:2*comp_size] = create_random_mode((comp_size, comp_size), random=False)
modes_weights[14, 3*comp_size:, 2*comp_size:3*comp_size] = create_random_mode((comp_size, comp_size), random=False)
modes_weights[15, 3*comp_size:, 3*comp_size:] = create_random_mode((comp_size, comp_size), random=False)


noise_weights[0, :comp_size, :comp_size] = create_random_mode((comp_size, comp_size), random=True)
noise_weights[1, :comp_size, comp_size:2*comp_size] = create_random_mode((comp_size, comp_size), random=True)
noise_weights[2, :comp_size, 2*comp_size:3*comp_size] = create_random_mode((comp_size, comp_size), random=True)
noise_weights[3, :comp_size, comp_size*3:] = create_random_mode((comp_size, comp_size), random=True)
noise_weights[4, comp_size:2*comp_size, :comp_size] = create_random_mode((comp_size, comp_size), random=True)
noise_weights[5, comp_size:2*comp_size, comp_size:2*comp_size] = create_random_mode((comp_size, comp_size), random=True)
noise_weights[6, comp_size:2*comp_size, 2*comp_size:3*comp_size] = create_random_mode((comp_size, comp_size), random=True)
noise_weights[7, comp_size:2*comp_size, 3*comp_size:] = create_random_mode((comp_size, comp_size), random=True)
noise_weights[8, 2*comp_size:3*comp_size, :comp_size] = create_random_mode((comp_size, comp_size), random=True)
noise_weights[9, 2*comp_size:3*comp_size, comp_size:2*comp_size] = create_random_mode((comp_size, comp_size), random=True)
noise_weights[10, 2*comp_size:3*comp_size, 2*comp_size:3*comp_size] = create_random_mode((comp_size, comp_size), random=True)
noise_weights[11, 2*comp_size:3*comp_size, 3*comp_size:] = create_random_mode((comp_size, comp_size), random=True)
noise_weights[12, 3*comp_size:, :comp_size] = create_random_mode((comp_size, comp_size), random=True)
noise_weights[13, 3*comp_size:, comp_size:2*comp_size] = create_random_mode((comp_size, comp_size), random=True)
noise_weights[14, 3*comp_size:, 2*comp_size:3*comp_size] = create_random_mode((comp_size, comp_size), random=True)
noise_weights[15, 3*comp_size:, 3*comp_size:] = create_random_mode((comp_size, comp_size), random=True)
...
links_coeffs = {
    ...
    5: [((5, -5), 0.5), ((10, -1), 0.27)],
    6: [((6, -1), 0.23), ((8, -2), 0.29)],
    7: [((7, -1), 0.41), ((13, -5), 0.23)],
    8: [((1, -4), 0.26), ((14, -1), 0.32)],
    9: [((2, -3), 0.35), ((11, -3), 0.21)],
    10: [((3, -2), 0.31)],
    11: [((4, -4), 0.28), ((12, -1), 0.32)],
    12: [((5, -5), 0.5)],
    13: [((6, -1), 0.23), ((14, -3), 0.26)],
    14: [((7, -1), 0.41), ((15, -4), 0.29)],
    15: [((8, -2), 0.15)]
}

comment = 'circlemodes_smalldistance_randomnoise_noseasonality_randomconnections'
...
name = f"m_{N}_x_{nx}_y_{ny}_cps_{comp_size}_tl_{time_len}_{comment}"
